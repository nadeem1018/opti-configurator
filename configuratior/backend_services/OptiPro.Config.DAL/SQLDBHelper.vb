...
Public NotInheritable Class SQLDBHelper
...
#Region "private utility methods & constructors"
    ...
    Private Shared Sub PrepareCommand(ByVal command As SqlCommand, _
        ...
        If commandText.Contains("bulk insert BMM_NUT_DATA") Then
...
#Region "FillDataset"
    ...
    ByVal commandText As String, ByVal dataSet As DataSet, ByVal tableNames As String(), _
       ByVal missingSchemaAction As MissingSchemaAction, ByVal ParamArray commandParameters() As SqlParameter)
...
#Region "ExecuteNonQueryTypedParams"
    ...
    Public Overloads Shared Function ExecuteNonQueryTypedParams(ByVal connectionString As String, ByVal spName As String, ByVal dataRow As DataRow) As Integer
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteNonQueryTypedParams = SQLDBHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteNonQueryTypedParams = SQLDBHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    Public Overloads Shared Function ExecuteNonQueryTypedParams(ByVal connection As SqlConnection, ByVal spName As String, ByVal dataRow As DataRow) As Integer
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteNonQueryTypedParams = SQLDBHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteNonQueryTypedParams = SQLDBHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    Public Overloads Shared Function ExecuteNonQueryTypedParams(ByVal transaction As SqlTransaction, ByVal spName As String, ByVal dataRow As DataRow) As Integer
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteNonQueryTypedParams = SQLDBHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters)
        Else

            ExecuteNonQueryTypedParams = SQLDBHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName)
        End If
    End Function
#End Region
...
#Region "ExecuteDatasetTypedParams"
    ...
    Public Overloads Shared Function ExecuteDatasetTypedParams(ByVal connectionString As String, ByVal spName As String, ByVal dataRow As DataRow) As DataSet
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteDatasetTypedParams = SQLDBHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters)
        Else

            ExecuteDatasetTypedParams = SQLDBHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    Public Overloads Shared Function ExecuteDatasetTypedParams(ByVal connection As SqlConnection, ByVal spName As String, ByVal dataRow As DataRow) As DataSet
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteDatasetTypedParams = SQLDBHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters)
        Else

            ExecuteDatasetTypedParams = SQLDBHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    Public Overloads Shared Function ExecuteDatasetTypedParams(ByVal transaction As SqlTransaction, ByVal spName As String, ByVal dataRow As DataRow) As DataSet
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteDatasetTypedParams = SQLDBHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters)
        Else

            ExecuteDatasetTypedParams = SQLDBHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName)
        End If
    End Function
#End Region
...
#Region "ExecuteReaderTypedParams"
    ...
    Public Overloads Shared Function ExecuteReaderTypedParams(ByVal connectionString As String, ByVal spName As String, ByVal dataRow As DataRow) As SqlDataReader
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteReaderTypedParams = SQLDBHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteReaderTypedParams = SQLDBHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    Public Overloads Shared Function ExecuteReaderTypedParams(ByVal connection As SqlConnection, ByVal spName As String, ByVal dataRow As DataRow) As SqlDataReader
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteReaderTypedParams = SQLDBHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteReaderTypedParams = SQLDBHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    Public Overloads Shared Function ExecuteReaderTypedParams(ByVal transaction As SqlTransaction, ByVal spName As String, ByVal dataRow As DataRow) As SqlDataReader
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteReaderTypedParams = SQLDBHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteReaderTypedParams = SQLDBHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName)
        End If
    End Function
#End Region
...
#Region "ExecuteScalarTypedParams"
    ...
    Public Overloads Shared Function ExecuteScalarTypedParams(ByVal connectionString As String, ByVal spName As String, ByVal dataRow As DataRow) As Object
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteScalarTypedParams = SQLDBHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteScalarTypedParams = SQLDBHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    Public Overloads Shared Function ExecuteScalarTypedParams(ByVal connection As SqlConnection, ByVal spName As String, ByVal dataRow As DataRow) As Object
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteScalarTypedParams = SQLDBHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteScalarTypedParams = SQLDBHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    Public Overloads Shared Function ExecuteScalarTypedParams(ByVal transaction As SqlTransaction, ByVal spName As String, ByVal dataRow As DataRow) As Object
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteScalarTypedParams = SQLDBHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteScalarTypedParams = SQLDBHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName)
        End If
    End Function
#End Region
...
#Region "ExecuteXmlReaderTypedParams"
    ...
    Public Overloads Shared Function ExecuteXmlReaderTypedParams(ByVal connection As SqlConnection, ByVal spName As String, ByVal dataRow As DataRow) As XmlReader
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteXmlReaderTypedParams = SQLDBHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteXmlReaderTypedParams = SQLDBHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    Public Overloads Shared Function ExecuteXmlReaderTypedParams(ByVal transaction As SqlTransaction, ByVal spName As String, ByVal dataRow As DataRow) As XmlReader
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteXmlReaderTypedParams = SQLDBHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteXmlReaderTypedParams = SQLDBHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName)
        End If
    End Function
#End Region
End Class ' SqlDBHelper

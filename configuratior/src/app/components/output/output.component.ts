...
export class OutputComponent implements OnInit {
  ...
  public getmodelsaveddetailsdata = [];
    ...
    this.OutputService.GetAllOutputData(operationType, logid, description).subscribe(
      data => {
        ...
        if (data.CustomerOutput.length > 0) {
          ...
          this.getmodelsaveddetailsdata = data.ModelBOMData
  ...
  onModelBillNextPress() {
    ...
    if (this.setModelDataFlag == true) {
      for (var i in this.step2_final_dataset_to_save) {
        for (var imodelsavedetaildata in this.getmodelsaveddetailsdata) {
          if (this.step2_final_dataset_to_save[i].OPTM_ITEMCODE == this.getmodelsaveddetailsdata[imodelsavedetaildata].OPTM_ITEMCODE && this.step2_final_dataset_to_save[i].PARENTID == this.getmodelsaveddetailsdata[imodelsavedetaildata].OPTM_PARENTID) {
            this.step2_final_dataset_to_save[i].OPTM_OUTPUTDTLID = this.getmodelsaveddetailsdata[imodelsavedetaildata].OPTM_OUTPUTDTLID
          }
        }
      }
      ...
      if (getmodelsavedata[imodelsavedata].OPTM_ITEMTYPE == 1) {
        ...
        if (getmodelsavedata[imodelsavedata].OPTM_LEVEL == 2) {
          ...
          ItemsArray = this.ModelHeaderItemsArray.filter(function (obj) {
            return obj['OPTM_ITEMKEY'] == getmodelsavedata[imodelsavedata].OPTM_ITEMCODE && obj['OPTM_TYPE'] == 2 &&  obj['OPTM_MODELID'] == getmodelsavedata[imodelsavedata].OPTM_PARENTID ;
          });
          if(ItemsArray.length>0){
            ItemsArray[0].OPTM_FEATUREID=getmodelsavedata[imodelsavedata].OPTM_PARENTID
          }
